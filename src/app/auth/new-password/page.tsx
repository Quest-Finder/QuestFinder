...
import newPasswordImage from '@/assets/images/new-password-image.jpg'
import { NewPasswordForm } from '@/components/auth'
import { NavLink } from '@/components/ui/nav-link'
import { ROUTES } from '@/constants'
import { NEW_PASSWORD_TEXTS } from '@/locales'

const pageTexts = NEW_PASSWORD_TEXTS.NewPasswordPage
    ...
    <>
      ...
      <main className='flex w-full flex-col gap-8 bg-background p-8 xs:p-12 md:h-[38rem] md:max-w-[27rem] lg:max-w-lg'>
        <header>
          ...
          <h1 className='pt-8 text-center text-3xl font-bold text-foreground-hard max-sm:text-center'>
            {pageTexts.title}
          </h1>
        </header>
